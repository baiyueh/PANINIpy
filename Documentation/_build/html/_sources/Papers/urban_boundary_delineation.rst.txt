...
**greedy_algorithm.py**
    Python module containing the code for implementing the greedy agglomerative algorithm.

**example.ipynb**
    Jupyter notebook containing an example use case of the greedy algorithm when used to perform spatial regionalization of the Baton Rouge, LA CBSA.

**Baton Rouge, LA.pkl**
    Pickled dictionary containing the spatial and flow edge lists for the Baton Rouge, LA CBSA. See example.ipynb for more information.

**geo_gdf.pkl**
    Pickled GeoPandas geodataframe containing the geometries for the Baton Rouge, LA CBSA. Used for plotting in example.ipynb.
...
Example output showing the spatial regionalization results for Baton Rouge, LA.
...
Paper source
------------
https://arxiv.org/pdf/2405.04911